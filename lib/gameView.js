(function(){
  ...
  GameView.prototype.drawMainMenu = function(ctx){
    ...
    if (this.showscore) {
      ...
      ctx.font = "100 40px Lato";
      ctx.fillText("Use the arrow keysa to move and space bar to shoot", this.game.DIM_X * 0.5, this.game.DIM_Y * 0.55);
    }

    ctx.font = "100 30px Lato";
    ctx.fillText("Press Enter To Begin", this.game.DIM_X * 0.5, this.game.DIM_Y * 0.87);

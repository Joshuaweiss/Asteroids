...
(function() {
  ...
  Coordinate.prototype.product = function(coordinate) {
    return (this.x * coordinate.x) + (this.y * coordinate.y)
  }

  Coordinate.prototype.angleFrom = function(vector) {
    return Math.acos( this.product(vector) / (this.norm() * vector.norm()))
  }
